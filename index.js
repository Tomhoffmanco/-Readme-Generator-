...
const questions = [
  {
    ...
    name: "name",
    message:
      "Welcome to the README generator! To start, please provide your full name:",
    validate: (nameInput) => {
      if (nameInput) {
        return true;
      } else {
  ...
  },
  {
    ...
    validate: (githubInput) => {
      if (githubInput) {
        ...
        console.log(
          "It is essential to link to your GitHub repo so users know where to find more of your work"
        );
        return false;
      }
    },
  },
  {
    ...
    validate: (emailInput) => {
      if (emailInput) {
        ...
        console.log(
          "If anyone has questions about your project, you must provide a way for them to contact you"
        );
        return false;
      }
    },
